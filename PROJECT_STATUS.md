...
an earlier cell already imported. Rebuilt/verified 45/45 notebooks. Omar
needs to re-run `Round6_TorchFEM_Comparison.ipynb` with this latest fix.
See item #13's row for the full story.)
