...
**Also still running, separately**: Omar's Colab Stage 1 preconditioner
re-check (item #4) — awaiting the finished N=701 result before deciding
whether to proceed to Stage 2 or rethink the preconditioner design; see
item #4's row.
