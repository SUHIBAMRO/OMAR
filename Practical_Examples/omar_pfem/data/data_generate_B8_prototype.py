"""FROZEN ARCHIVE -- B8-prototype/pilot (2026-09-22/23), kept unmodified
and self-contained per explicit instruction (2026-09-23): this is the
exact geometry/material code behind the real, GPU-confirmed pilot
result (region-Cauchy field error 7.53% at 791,864 elements). It uses
an arbitrary 100x shim/rubber stiffness ratio (not the real ~1e5
steel/rubber contrast, let alone real linear-elastic steel) and
nondimensional geometry (not a published bearing's real dimensions) --
both real limitations, NOT fixed here; B8-final (data_generate_B8.py)
replaces this with a published bearing's real geometry/materials and a
corrected stress-QoI region. Do not edit this file -- it exists so the
pilot result stays independently reproducible.

Original docstring: FEM geometry/BC generator for B8: a 3D laminated
annular elastomeric seismic bearing -- Option B from the 2026-09-22
candidate-direction discussion, proposed as a genuinely harder 3D
benchmark than B3 for Timon's stated target (10^5-10^6 elements, 5-10%
QoI error).
