    ...
    return {
        ...
        "cells": [
            md(
                ...
                "قليل جدًا مقارنة بأرقام حقيقية مسجّلة بمشروعنا نفسه -- "
                "B1 وصل لأفضل نتيجة عند 57,500-70,000 خطوة (~5-10% "
                "خطأ)، وB2×neo-Hookean عند 275,000 خطوة (3.3% خطأ). "
                "B3 استخدم بس 2000 خطوة. عمر قرر (بدل مرحلتين) نروح "
                "مباشرة لـ**50,000 خطوة** بالتشغيلة الثالثة، وهالدفتر "
                "هلق موجّه على `checkpoint_50000.pt` (نتيجة هاي "
                "التشغيلة الأطول).",
                "",
                "**شو بيعمل بالضبط**:",
                ...
                "50,000 خطوة، هيك بنعرف إنه المشكلة أعمق من مجرد قلة "
