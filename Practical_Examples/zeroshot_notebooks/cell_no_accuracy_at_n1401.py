...
# from the round-5/6 comparison study). This is very likely the real
# explanation for the "catastrophic 640% error at N=1401" result: a real
# GPU run confirmed the SAME ~620-640% error at every N from 13 to 1401
# with this fallback active, which is the signature of evaluating the
# wrong model everywhere, not a resolution-dependent accuracy failure.
