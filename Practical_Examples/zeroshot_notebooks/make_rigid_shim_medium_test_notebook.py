    ...
    return {
        ...
        "cells": [
            md(
                ...
                "",
                "**تحديث ثاني، نفس اليوم -- نتيجة حقيقية بالسلب**: عند "
                "(45,23)=75,504 عنصر، CG (بشرط Jacobi البسيط) **ما "
                "بطّأ بس، بل انهار فعليًا**: عدد تكرارات CG انفجر "
                "(4,275 -> 6,673 -> 13,129)، residual نيوتن نفسه صار "
                "**يكبر** بدل ما ينزل (1.19e5 -> 2.27e6 -> 1.23e9)، "
                "وانتهى بخطأ `non-positive diagonal` (المصفوفة نفسها "
                "صارت غير صالحة). هاد أسوأ من بطء الحل المباشر، وهو "
                "بالضبط التحذير يلي كان مكتوب من البداية: احتمال مشكلة "
                "\"locking\" حقيقية عند هالحجم، مستقلة عن اختيار "
                "الحلّال. **رجّعنا (45,23) و(53,27) لاستخدام الحل "
                "المباشر** (أبطأ بس موثوق)، وCG هلا مثبت وصحيح بس عند "
                "الحجم الصغير فقط -- تحسين شرط الحلّال (preconditioner "
                "أقوى) شغلة منفصلة قادمة، مش شرط لإكمال هاي التجربة.",
            ),
