...
bars0 = axes[0].bar(LABELS, TRAIN_HOURS, color=[DIRECT_COLOR, MULTIRES_COLOR], width=0.55)
...
bars1 = axes[1].bar(LABELS, ACCURACY_PCT, color=[DIRECT_COLOR, MULTIRES_COLOR], width=0.55)
