...
out of PFEM_Transolver_Report_2026-09-24e.docx -- the round-15 and
...
REPORT = os.path.join(DELIV, 'PFEM_Transolver_Report_2026-09-24e.docx')
OUT = os.path.join(DELIV, 'PFEM_Work_Summary_2026-09-24b.docx')
...
p.add_run(
    ...
    "Report (PFEM_Transolver_Report_2026-09-24e.docx) -- nothing "
